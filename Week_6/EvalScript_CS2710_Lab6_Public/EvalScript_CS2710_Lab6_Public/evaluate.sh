...
# Configuration
LAB_NO=6      # Change this to the appropriate lab number
TIME_LIMIT="10"  # Set this to the time limit for each test case execution in seconds, or leave empty for no limit
